          ...
          <div className='flex justify-center flex-col lg:flex-row gap-6 py-6'>
            <div className='flex-1 px-4'>
              <div className='flex items-center gap-2'>
                ...
                <h1 className='text-2xl font-bold text-left'>Shopping means ShopFire.</h1>
              </div>
              <p className='text-left p-3'>
                Discover an unparalleled shopping experience at <strong>ShopFire</strong>. 
                We bring you high-quality products, the best deals, and seamless service. 
                Shop with confidence and ignite your style with the latest trends.
              </p>
