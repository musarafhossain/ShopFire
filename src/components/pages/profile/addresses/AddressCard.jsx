            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="absolute right-4 top-2">
                    <div
                        ...
                        onMouseEnter={() => setIsOptionMenuOpen(true)}
                        onMouseLeave={() => setIsOptionMenuOpen(false)}
                    >
                        <BsThreeDotsVertical />
                        {isOptionMenuOpen &&
                            <div className={`flex flex-col absolute right-0 top-0 overflow-hidden text-sm ${isDarkMode ? "bg-gray-800" : "bg-white"} rounded shadow`}>
                                <button
